...
public class ConnectToSQL {
    ...
    public Connection getConnection() throws Exception {
        String dbURL = "jdbc:sqlserver://localhost:1433;databaseName=SINHVIEN;encrypt=true;trustServerCertificate=true";
        String user = "sa";
        String pass = "12345";
    ...
    public boolean update(Student sv) throws Exception {
        String update = "update STUDENTS set Hoten =?, Email = ? where Masv = ?";
        try (
    ...
    public List<Student> getAllData() throws Exception {
        ...
        try (
            ...
            try ( ResultSet rs = pmst.executeQuery()) {
                ...
                while (rs.next()) {
                    Student sv = new Student(rs.getString(1), rs.getString(2), rs.getString(3));
                    list.add(sv);
                }
                return list;
            }
